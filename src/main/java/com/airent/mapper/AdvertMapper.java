...
public interface AdvertMapper {
    ...
    @Insert("INSERT INTO advert (publicationDate, district, address, floor, maxFloor, rooms, sq, price, conditions, description) " +
            "VALUES (#{publicationDate}, #{district}, #{address}, #{floor}, #{maxFloor}, #{rooms}, #{sq}, #{price}, #{conditions}, #{description})")
